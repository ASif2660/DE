...
*/
    ...
    warpPerspective(plotted_image, _destination, transformationMat, image_size, cv::INTER_CUBIC | cv::WARP_INVERSE_MAP);
...
std::vector<std::vector<cv::Vec4i> > birdsEye::lineSeparation(std::vector<cv::Vec4i> lines, cv::Mat img_edges) {
